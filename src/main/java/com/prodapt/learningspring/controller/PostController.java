...
//
//    @Autowired
//    private SortingPosts sortingPosts;
//
// 
//
//    @Autowired
...
////      List<Comment> comments = commentRepository.findByPostIdOrderByLikesDescDateAsc(id);
...
//    }
//    // Sample method to retrieve posts (replace with your actual logic)
//    private List<Post> getPosts() {
//        // Implement your logic to fetch posts from the repository or service
...
// 
//
//    @GetMapping("/posts/sortByTimestamp")
//    public String sortByTimestamp(Model model) {
//        List<Post> posts = (List<Post>) postRepository.findAll();
//        // Sort posts by timestamp using the sortingPosts service
//        posts = sortingPosts.sortPostsByTimestamp(posts);
//        model.addAttribute("posts", posts);
//        return "forum/sortPost"; // Replace with the name of your HTML template
//    }
//
// 
//
//    @GetMapping("/posts/filterByDateRange")
//    public String filterByDateRange(
//            @RequestParam("startDate") Date startDate,
//            @RequestParam("endDate") Date endDate,
//            Model model) {
//        List<Post> posts = (List<Post>) postRepository.findAll();
//        // Filter posts by date range using the sortingPosts service
//        posts = sortingPosts.filterPostsByDateRange(posts, startDate, endDate);
//        model.addAttribute("posts", posts);
//        return "forum/sortPost"; // Replace with the name of your HTML template
//    }
//}